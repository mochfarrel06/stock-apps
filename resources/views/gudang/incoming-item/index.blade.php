...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.heading-page :title="'Halaman Barang Masuk'" :breadcrumbs="[['title' => 'Dashboard', 'url' => route('gudang.dashboard')], ['title' => 'Barang Masuk']]" />

        <x-content.table-container>

            <x-content.table-header :title="'Tabel Barang Masuk'" :icon="'fas fa-download'" :addRoute="'gudang.incoming-item.create'" />

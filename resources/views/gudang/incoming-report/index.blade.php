...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.heading-page :title="'Halaman Laporan Barang Masuk'" :breadcrumbs="[['title' => 'Dashboard', 'url' => route('gudang.dashboard')], ['title' => 'Laporan Barang Masuk']]" />
        ...
        <x-content.table-container>
            ...
            <div class="card-body">
                <form action="{{ route('gudang.incoming-report.index') }}" method="GET">
                    @csrf
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('gudang.incoming-report.exportPdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                            class="btn btn-warning mr-2 mb-2"><i class="fas fa-solid fa-file-pdf"></i> Export
                            PDF</a>
                        <a href="{{ route('gudang.incoming-report.exportExcel', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"

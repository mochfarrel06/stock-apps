...
@section('content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Lihat Barang Keluar</h1>
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Lihat Barang Keluar</h6>
                    </div>
                    <div class="card-body">
                        <form>
                            @csrf
                            ...
                            <a href="{{ route('gudang.outgoing-item.index') }}" class="btn btn-warning mt-3">Kembali</a>
                        </form>
                    </div>
                </div>

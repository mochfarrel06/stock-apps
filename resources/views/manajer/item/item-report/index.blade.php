...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.heading-page :title="'Halaman Laporan Data Barang'" :breadcrumbs="[['title' => 'Dashboard', 'url' => route('manajer.dashboard')], ['title' => 'Laporan Data Barang']]" />
        ...
        <x-content.table-container>
            ...
            <div class="card-body">
                <form action="{{ route('manajer.item-report.index') }}" method="GET">
                    @csrf
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('manajer.item-report.exportPdf', ['filter' => request('filter')]) }}"
                            class="btn btn-warning mr-2 mb-2"><i class="fas fa-solid fa-file-pdf"></i> Export
                            Data</a>

                        <a href="{{ route('manajer.item-report.exportExcel', ['filter' => request('filter')]) }}"

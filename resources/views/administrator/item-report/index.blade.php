...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.heading-page :title="'Halaman Laporan Data Barang'" :breadcrumbs="[['title' => 'Dashboard', 'url' => route('admin.dashboard')], ['title' => 'Laporan Data Barang']]" />

        <x-content.table-container>

            <x-content.table-header :title="'Filter Stok Barang'" :icon="'fas fa-solid fa-filter'" />
            <div class="card-body">
                <form action="{{ route('admin.item-report.index') }}" method="GET">
                    @csrf
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('admin.item-report.exportPdf', ['filter' => request('filter')]) }}"
                            class="btn btn-warning mr-2 mb-2"><i class="fas fa-solid fa-file-pdf"></i> Export
                            Data</a>

                        <a href="{{ route('admin.item-report.exportExcel', ['filter' => request('filter')]) }}"

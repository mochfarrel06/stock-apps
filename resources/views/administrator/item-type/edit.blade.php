        ...
        <div class="d-lg-flex align-items-center justify-content-between mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 mt-2">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.item-type.index') }}">Jenis Barang</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="main-form" action="{{ route('admin.item-type.update', $itemType->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label for="name">Jenis Barang</label>
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" id="name" value="{{ old('name', $itemType->name) }}">
                                @error('name')

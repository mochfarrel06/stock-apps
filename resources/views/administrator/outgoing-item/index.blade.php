...
@section('content')
    <x-content.container-fluid>
        ...
        <x-content.heading-page :title="'Halaman Barang Keluar'" :breadcrumbs="[['title' => 'Dashboard', 'url' => route('admin.dashboard')], ['title' => 'Barang Keluar']]" />

        <x-content.table-container>

            <x-content.table-header :title="'Tabel Barang Keluar'" :icon="'fas fa-upload'" :addRoute="'admin.outgoing-item.create'" />
                ...
                <x-content.tbody>
                    @foreach ($outgoingItems as $outgoingItem)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.outgoing-item.show', $outgoingItem->id) }}"
                                    class="btn btn-warning mr-2 mb-2"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('admin.outgoing-item.destroy', $outgoingItem->id) }}"

        ...
        <div class="d-lg-flex align-items-center justify-content-between mb-4">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 mt-2">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.outgoing-item.index') }}">Barang Keluar</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form id="main-form" action="{{ route('admin.outgoing-item.store') }}" method="POST">
                            @csrf
                            ...
                            <a href="{{ route('admin.outgoing-item.index') }}"
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href =
                                "{{ route('admin.outgoing-item.index') }}"; // Redirect to index page
                        } else {

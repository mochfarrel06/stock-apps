...
class ManajerOutgoingItemReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manajer.outgoing-item.outgoing-report.index', compact('outgoingItems', 'startDate', 'endDate'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('manajer.outgoing-item.outgoing-report.exportPdf', compact('startDate', 'endDate', 'outgoingItems'));

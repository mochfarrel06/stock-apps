...
class ManajerItemReportController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manajer.item.item-report.index', compact('items', 'filter'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('manajer.item.item-report.exportPdf', compact('items', 'filter', 'titlePdf'));

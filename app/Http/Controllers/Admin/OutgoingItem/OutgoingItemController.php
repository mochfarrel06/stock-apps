...
class OutgoingItemController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('administrator.outgoing-item.index', compact('outgoingItems'));
    }
    ...
    public function create()
    {
        ...
        return view('administrator.outgoing-item.create', compact('items'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('administrator.outgoing-item.show', compact('outgoingItem', 'item'));
    }

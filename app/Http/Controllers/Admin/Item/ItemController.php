...
class ItemController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('administrator.item.create', compact('itemTypes', 'unitTypes'));
    }
    ...
    public function show(string $id)
    {
        ...
        return view('administrator.item.show', compact('item', 'itemType', 'unitType'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('administrator.item.edit', compact('item', 'itemTypes', 'unitTypes'));
    }
